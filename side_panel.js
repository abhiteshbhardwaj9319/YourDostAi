...
//   // Function to make an API call to Wit.ai Chatbot
//   const witAiEndpoint = 'https://api.wit.ai/message';
//   const witAiKey = 'YWS73MYAOWAIQJCFNEDH4KKJXQLCX6ML';

//   async function callWitAiChatbot(userQuestion) {
...
//     // Make the API call to Wit.ai Chatbot using the fetch API
//     try {
//       const response = await fetch(`${witAiEndpoint}?v=20230723&q=${encodeURIComponent(userQuestion)}`, {
//         method: 'GET',
//         headers: {
//           'Authorization': `Bearer ${witAiKey}`,
//         },
//       });

//       if (!response.ok) {
//         throw new Error('Error calling Wit.ai Chatbot: ' + response.statusText);
//       }

//       const data = await response.json();
//       const chatbotResponse = data.text || 'Oops! No response from the Chatbot. Please try again.';
...
//     } catch (error) {
//       console.error('Error calling Wit.ai Chatbot:', error);
...
//         // Call the Wit.ai Chatbot API
//         callWitAiChatbot(userQuestion);
//       }
//     });

//     document.getElementById('side-panel-submit-btn').addEventListener('click', function () {
//       displayTextInputBox();
//     });
